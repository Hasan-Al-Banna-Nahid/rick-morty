...
const EpisodeCard = ({ episode, className = "" }) => {
  return (
    <div
      className={`block group  fontRickMortySub ${className} hover:cursor-auto`}
    >
      <div
      ...
      >
        ...
        >
          <h2 className="text-base sm:text-lg text-white">{episode.episode}</h2>
